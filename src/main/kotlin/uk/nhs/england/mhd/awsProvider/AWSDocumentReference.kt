    ...
    fun createUpdateAWSDocumentReference(newDocumentReference: DocumentReference, bundle: Bundle?): DocumentReference? {
        ...
        for (participant in newDocumentReference.author) {
            if (participant.hasIdentifier()) {
                if (participant.identifier.system.equals(uk.nhs.england.mhd.util.FhirSystems.NHS_GMC_NUMBER)||
                    participant.identifier.system.equals(uk.nhs.england.mhd.util.FhirSystems.NHS_GMC_NUMBER)) {
                    ...
                    } else if (participant.identifier.system.equals(uk.nhs.england.mhd.util.FhirSystems.ODS_CODE)) {
