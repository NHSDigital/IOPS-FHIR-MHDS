package uk.nhs.england.mhd.awsProvider
...
import uk.nhs.england.mhd.configuration.MessageProperties
...
class AWSAuditEvent(@Qualifier("R4") val ctx: FhirContext,
    ...
    fun createAudit(resource : Resource, auditEventAction: AuditEvent.AuditEventAction?): AuditEvent {
        ...
        entityComponent.type = Coding().setSystem(uk.nhs.england.mhd.util.FhirSystems.FHIR_RESOURCE_TYPE).setCode("Patient")
