...
class AWSPatient (val messageProperties: MessageProperties, val awsClient: IGenericClient,
               //sqs: AmazonSQS?,
                  ...
                  val awsAuditEvent: uk.nhs.england.mhd.awsProvider.AWSAuditEvent
) {
        ...
        if (newPatient.hasGeneralPractitioner()) {
            ...
            for (generalPractitioner in newPatient.generalPractitioner) {
                if (generalPractitioner.hasIdentifier() ) {
                    if (generalPractitioner.identifier.system.equals(uk.nhs.england.mhd.util.FhirSystems.ODS_CODE)) {
                    ...
                    if (generalPractitioner.identifier.system.equals(uk.nhs.england.mhd.util.FhirSystems.NHS_GMP_NUMBER) || generalPractitioner.identifier.system.equals(
                            uk.nhs.england.mhd.util.FhirSystems.NHS_GMC_NUMBER)) {
        ...
        if (reference.hasReference()) {
            ...
            if (resource != null && resource is Patient) {
                ...
                for ( identifier in patient.identifier) {
                    if (identifier.system.equals(uk.nhs.england.mhd.util.FhirSystems.NHS_NUMBER)) {
